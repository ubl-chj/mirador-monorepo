...
import AnnotationSettings from '../../../../containers/workspace/window/companion-area/AnnotationSettings';
import CompanionWindow from '../../../../containers/workspace/window/companion-area/CompanionWindow';
