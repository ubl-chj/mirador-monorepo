...
import ThumbnailNavigation from '../../../../containers/workspace/window/companion-area/ThumbnailNavigation';
import WindowSideBarAnnotationsPanel from '../../../../containers/workspace/window/companion-area/WindowSideBarAnnotationsPanel';
import WindowSideBarCanvasPanel from '../../../../containers/workspace/window/companion-area/WindowSideBarCanvasPanel';
import WindowSideBarInfoPanel from '../../../../containers/workspace/window/companion-area/WindowSideBarInfoPanel';
