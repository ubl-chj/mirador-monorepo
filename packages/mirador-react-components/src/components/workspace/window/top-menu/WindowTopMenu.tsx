...
import WindowThumbnailSettings from '../../../../containers/workspace/window/top-menu/WindowThumbnailSettings';
import WindowViewSettings from '../../../../containers/workspace/window/top-menu/WindowViewSettings';
