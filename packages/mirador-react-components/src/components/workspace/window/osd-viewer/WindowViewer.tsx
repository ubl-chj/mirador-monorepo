...
import OSDViewer from '../../../../containers/workspace/window/osd-viewer/OpenSeadragonViewer';
import WindowCanvasNavigationControls from '../../../../containers/workspace/window/osd-viewer/WindowCanvasNavigationControls';
